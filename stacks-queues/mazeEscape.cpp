...
private:
  ...
  const char exitMarker, visitedMarker, entryMarker, moveableMarker,
      wallMarker;
...
Maze::Maze ()
    : entryMarker ('m'), exitMarker ('e'), visitedMarker ('.'),
      moveableMarker ('0'), wallMarker ('1')
{
  Stack<char *> mazeRows;
...
void
Maze::pushUnvisited (int x, int y)
{
...
ostream &
operator<< (ostream &out, const Maze &maze)
{
